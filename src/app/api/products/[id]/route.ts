...
export async function GET(
  ...
  try {
    ...
    const [allVariants, allRecipes, allIngredients, [cat]] = await Promise.all([
...
export async function PUT(
  ...
  try {
    ...
    const updated = await db.transaction(async (tx) => {
      ...
      // Hapus varian lama & masukkan varian baru
      ...
      // Hapus resep lama & masukkan resep baru
...
export async function DELETE(
  ...
  try {
    ...
    // Jika produk baru atau belum pernah dipesan, hapus resep, varian, dan produk secara permanen
